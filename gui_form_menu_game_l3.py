...
class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        #elementos                                                        
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images/fondos_dbz/8.png")
        ...
        self.enemy_list = []
        self.enemy_list.append (Enemy(x=850,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.19,interval_time_jump=300))
        ...
        self.botin_list.append(Botin(x=1250,y=550,width=50,height=50,type=0))
        self.botin_list.append(Botin(x=800,y=550,width=50,height=50,type=0))
        self.botin_list.append(Botin(x=470,y=550,width=50,height=50,type=0))
    ...
    def shoot_enemy(self):
        ...
        pygame.time.set_timer(self.timer_3s,1000)
    ...
    def update(self, lista_eventos,keys,delta_ms):
        ...
        if self.player_1.score >= 1400:
            win_screen = WinScreen(ANCHO_VENTANA, ALTO_VENTANA)
            win_screen.show()
